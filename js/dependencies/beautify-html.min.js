...
! function()
{
    ! function()
    {
        ...
        var _ = [, , function(t)
            ...
            }, function(t)
            {
                ...
                {
                    this.type = t, this.text = e, this.comments_before = null, this.newlines = n || 0, this.whitespace_before = _ || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null
                }
            }, , , function(t)
            {
                function e(t, e)
                ...
                }, t.exports.Options = e, t.exports.normalizeOpts = i, t.exports.mergeOpts = n
            }, , function(t)
            {
            ...
            }, function(t, e, n)
            {
                function _(t, e)
                {
                    this._input = new i(t), this._options = e ||
                    {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new a(this._input)
                }
                ...
                _.prototype.tokenize = function()
                {
                    ...
                    for (var t, e = new s(o.START, ""), n = null, _ = [], i = new r; e.type !== o.EOF;)
                    {
                        ...
                        i.isEmpty() || (t.comments_before = i, i = new r), t.parent = n, this._is_opening(t) ? (_.push(n), n = t) : n && this._is_closing(t, n) && ((t.opened = n).closed = t, n = _.pop(), t.parent = n), (t.previous = e).next = t, this.__tokens.add(t), e = t
                    }
                    return this.__tokens
                }, _.prototype._is_first_token = function()
                {
                    return this.__tokens.isEmpty()
                }, _.prototype._reset = function() {}, _.prototype._get_next_token = function(t, e)
                {
                ...
                }, t.exports.Tokenizer = _, t.exports.TOKEN = o
            }, function(t)
            {
                function e(t)
                {
            ...
            }, function(t, e, n)
            {
                ...
                function s(t, e)
                {
                    _.call(this, t, e), this.__template_pattern = null, this._disabled = Object.assign(
                    {}, i), this._excluded = Object.assign(
                    {}, i), e && (this.__template_pattern = this._input.get_regexp(e.__template_pattern), this._excluded = Object.assign(this._excluded, e._excluded), this._disabled = Object.assign(this._disabled, e._disabled));
                    e = new _(t);
                    this.__patterns = {
                ...
                }, s.prototype._read_template = function()
                {
                    var t, e = "",
                        n = this._input.peek();
                    return "<" === n ? (t = this._input.peek(1), this._disabled.php || this._excluded.php || "?" !== t || (e = e || this.__patterns.php.read()), this._disabled.erb || this._excluded.erb || "%" !== t || (e = e || this.__patterns.erb.read())) : "{" === n && (this._disabled.handlebars || this._excluded.handlebars || (e = (e = (e = e || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars_unescaped.read()) || this.__patterns.handlebars.read()), this._disabled.django || (this._excluded.django || this._excluded.handlebars || (e = e || this.__patterns.django_value.read()), this._excluded.django || (e = (e = e || this.__patterns.django_comment.read()) || this.__patterns.django.read())), this._disabled.smarty || this._disabled.django && this._disabled.handlebars && (e = (e = (e = e || this.__patterns.smarty_comment.read()) || this.__patterns.smarty_literal.read()) || this.__patterns.smarty.read())), e
            ...
            }, function(t, e, n)
            {
                ...
                function s(t, e)
                {
                    ...
                    return e.closed ? ("script" === t ? n = "text/javascript" : "style" === t && (n = "text/css"), -1 < (n = function(t)
                    {
                        ...
                        return e
                    }(e) || n).search("text/css") ? _ = "css" : -1 < n.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) ? _ = "javascript" : -1 < n.search(/(text|application|dojo)\/(x-)?(html)/) ? _ = "html" : -1 < n.search(/test\/null/) && (_ = "null"), _) : null
                }
                var i = n(20).Options,
                    _ = n(2).Output,
                    h = n(21).Tokenizer,
                ...
                function g(t, e, n, _)
                {
                    this._source_text = t || "", e = e ||
                    {}, this._js_beautify = n, this._css_beautify = _, this._tag_stack = null;
                    t = new i(e, "html");
                ...
                }, g.prototype._handle_control_flow_open = function(t, e)
                {
                    ...
                    return t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0), e.newlines ? t.print_preserved_newlines(e) : t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0), t.print_token(e), t.indent(), n
                ...
                }, g.prototype._print_custom_beatifier_text = function(t, e, n)
                {
                    ...
                    if ("" !== e.text)
                    {
                        var i, s = e.text,
                            ...
                            a = "",
                            o = "",
                            r = ("javascript" === n.custom_beautifier_name && "function" == typeof this._js_beautify ? i = this._js_beautify : "css" === n.custom_beautifier_name && "function" == typeof this._css_beautify ? i = this._css_beautify : "html" === n.custom_beautifier_name && (i = function(t, e)
                            {
                                return new g(t, e, _._js_beautify, _._css_beautify).beautify()
                            }), "keep" === this._options.indent_scripts ? r = 0 : "separate" === this._options.indent_scripts && (r = -t.indent_level), t.get_full_indent(r));
                        ...
                        {
                            this.eol = "\n"
                        }).prototype = this._options.raw_options, i(r + s, new n)) : r + (s = (i = e.whitespace_before) ? s.replace(new RegExp("\n(" + i + ")?", "g"), "\n") : s).replace(/\n/g, "\n" + r)), a && (s = s ? a + s + "\n" + o : a + o), t.print_newline(!1), s && (e.text = s, e.whitespace_before = "", e.newlines = 0, t.add_raw_token(e), t.print_newline(!0))
                    }
                ...
                var f = function(t, e, n)
                    ...
                    o = (g.prototype._get_tag_open_token = function(t)
                    {
            ...
            }, function(t, e, n)
            {
                ...
                {
                    return t.type === p.TAG_CLOSE && e && ((">" === t.text || "/>" === t.text) && "<" === e.text[0] || "}}" === t.text && "{" === e.text[0] && "{" === e.text[1]) || t.type === p.CONTROL_FLOW_CLOSE && "}" === t.text && e.text.endsWith("{")
                ...
                }, _.prototype._get_next_token = function(t, e)
                {
                    ...
                    return null === n ? this._create_token(p.EOF, "") : this._read_open_handlebars(n, e) || this._read_attribute(n, t, e) || this._read_close(n, e) || this._read_script_and_style(n, t) || this._read_control_flows(n, e) || this._read_raw_content(n, t, e) || this._read_content_word(n, e) || this._read_comment_or_cdata(n) || this._read_processing(n) || this._read_open(n, e) || this._create_token(p.UNKNOWN, this._input.next())
                }, _.prototype._read_comment_or_cdata = function(t)
                {
                    var e = null,
                        n = null,
                        _ = null;
                    return "<" === t && ("!" === this._input.peek(1) && ((n = this.__patterns.comment.read()) ? (_ = h.get_directives(n)) && "start" === _.ignore && (n += h.readIgnored(this._input)) : n = this.__patterns.cdata.read()), n && ((e = this._create_token(p.COMMENT, n)).directives = _)), e
                }, _.prototype._read_processing = function(t)
                {
                    var e = null,
                        n = null;
                    return "<" === t && (n = "!" !== (t = this._input.peek(1)) && "?" !== t ? n : (n = this.__patterns.conditional_comment.read()) || this.__patterns.processing.read()) && ((e = this._create_token(p.COMMENT, n)).directives = null), e
                }, _.prototype._read_open = function(t, e)
                {
                    var n = null,
                        _ = null;
                    return e && e.type !== p.CONTROL_FLOW_OPEN || "<" === t && (n = this._input.next(), "/" === this._input.peek() && (n += this._input.next()), n += this.__patterns.element_name.read(), _ = this._create_token(p.TAG_OPEN, n)), _
                }, _.prototype._read_open_handlebars = function(t, e)
                {
                    var n = null,
                        _ = null;
                    return e && e.type !== p.CONTROL_FLOW_OPEN || (this._options.templating.includes("angular") || this._options.indent_handlebars) && "{" === t && "{" === this._input.peek(1) && (_ = this._options.indent_handlebars && "!" === this._input.peek(2) ? (n = (n = this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars.read(), this._create_token(p.COMMENT, n)) : (n = this.__patterns.handlebars_open.read(), this._create_token(p.TAG_OPEN, n))), _
                ...
                }, _.prototype._read_close = function(t, e)
                {
                    var n = null,
                        _ = null;
                    return e && e.type === p.TAG_OPEN && ("<" === e.text[0] && (">" === t || "/" === t && ">" === this._input.peek(1)) ? (n = this._input.next(), "/" === t && (n += this._input.next()), _ = this._create_token(p.TAG_CLOSE, n)) : "{" === e.text[0] && "}" === t && "}" === this._input.peek(1) && (this._input.next(), this._input.next(), _ = this._create_token(p.TAG_CLOSE, "}}"))), _
                }, _.prototype._read_attribute = function(t, e, n)
                {
                    var _ = null;
                    return n && "<" === n.text[0] && ("=" === t ? _ = this._create_token(p.EQUALS, this._input.next()) : '"' === t || "'" === t ? (n = this._input.next(), n += ('"' === t ? this.__patterns.double_quote : this.__patterns.single_quote).read(), _ = this._create_token(p.VALUE, n)) : (t = this.__patterns.attribute.read()) && (_ = e.type === p.EQUALS ? this._create_token(p.VALUE, t) : this._create_token(p.ATTRIBUTE, t))), _
                ...
                {
                    var _ = "";
                    return n && "{" === n.text[0] ? _ = this.__patterns.handlebars_raw_close.read() : e.type === p.TAG_CLOSE && "<" === e.opened.text[0] && "/" !== e.text[0] && (n = e.opened.text.substr(1).toLowerCase(), this._is_content_unformatted(n) && (_ = this._input.readUntil(new RegExp("</" + n + "[\\n\\r\\t ]*?>", "ig")))), _ ? this._create_token(p.TEXT, _) : null
                ...
                {
                    var n = "";
                    return (n = (n = this._options.unformatted_content_delimiter && t === this._options.unformatted_content_delimiter[0] ? this.__patterns.unformatted_content_delimiter.read() : n) || (e && e.type === p.CONTROL_FLOW_OPEN ? this.__patterns.word_control_flow_close_excluded : this.__patterns.word).read()) ? this._create_token(p.TEXT, n) : null
                }, t.exports.Tokenizer = _, t.exports.TOKEN = p
            }],
            i = {};
        var t = function t(e)
        {
    ...
    }) : "undefined" != typeof exports ? (n = require("./beautify.js"), _ = require("./beautify-css.js"), exports.html_beautify = function(t, e)
    {
        return i(t, e, n.js_beautify, _.css_beautify)
    }) : "undefined" != typeof window ? window.html_beautify = function(t, e)
    {
